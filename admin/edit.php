...
if (isset($_POST["kirim"])) {
    ...
    $sql = "UPDATE `mahasiswa` SET `nim`='$nim',`nama`='$nama',`tanggal_lahir`='$tanggal_lahir',`jurusan`='$jurusan'";
...
<body class="bg-gray-100 flex">
    ...
    <aside class="relative bg-[#3d68ff] h-screen w-64 hidden sm:block shadow-xl">
        <div class="p-6">
            <a href="index.php" class="text-white text-3xl font-semibold uppercase hover:text-gray-300"><?= $namadia ?>
            </a>
        ...
        <header class="w-full items-center bg-white py-2 px-6 hidden sm:flex">
            ...
            <div x-data="{ isOpen: false }" class="relative w-1/2 flex justify-end">
                ...
                <div x-show="isOpen" class="absolute w-32 bg-white rounded-lg shadow-lg py-2 mt-16">
                    <a href="../index.html" class="block px-4 py-2      hover:text-[#3d68ff]">Logout</a>
                </div>
            </div>
        </header>
                            ...
                            <form class="p-10 bg-white rounded shadow-xl space-y-5" id="myForm" method="POST">
                                <div>
                                    ...
                                    <input type="text" id="nim" name="nim"
                                        ...
                                        placeholder="nim" value="<?= $data['nim']; ?>" required />
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <input type="text" id="jurusan" name="jurusan"
                                        class="shadow-sm border text-[#274C5B] text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5"
                                        placeholder="Jurusan" required value="<?= $data['jurusan']; ?>" />
                                </div>
        ...
        $(document).ready(function () {
            $("#myForm").validate({
                ...
                messages: {
                    ...
                    kategori: {
                        required: "Silakan pilih kategori Anda",
                    },
                },
            });
        });
